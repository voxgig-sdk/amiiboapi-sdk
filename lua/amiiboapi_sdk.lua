...
local AmiiboapiSDK = {}
AmiiboapiSDK.__index = AmiiboapiSDK
...
AmiiboapiSDK._make_feature = _make_feature


function AmiiboapiSDK.new(options)
  local self = setmetatable({}, AmiiboapiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AmiiboapiSDK:options_map()
...
function AmiiboapiSDK:get_utility()
  return Utility.copy(self._utility)
end


function AmiiboapiSDK:get_root_ctx()
  return self._rootctx
end


function AmiiboapiSDK:prepare(fetchargs)
...
function AmiiboapiSDK:direct(fetchargs)
...
-- by passing it.
function AmiiboapiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AmiiboapiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AmiiboapiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AmiiboapiSDK:Amiibo(data)
  ...
  if data == nil then
    if self._amiibo == nil then
      self._amiibo = EntityMod.new(self, nil)
    end
    return self._amiibo
  end
...
function AmiiboapiSDK:Amiiboseries(data)
  ...
  if data == nil then
    if self._amiiboseries == nil then
      self._amiiboseries = EntityMod.new(self, nil)
    end
    return self._amiiboseries
  end
  return EntityMod.new(self, data)
end
...
function AmiiboapiSDK:Gameseries(data)
  ...
  if data == nil then
    if self._gameseries == nil then
      self._gameseries = EntityMod.new(self, nil)
    end
    return self._gameseries
  end
  return EntityMod.new(self, data)
end
...
function AmiiboapiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AmiiboapiSDK.new(sdkopts)
  sdk.mode = "test"
