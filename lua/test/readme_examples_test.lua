...
local SDK_MODULE = "amiiboapi_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["amiibo"] = { ["test01"] = { id = "test01" } }, ["amiiboseries"] = { ["test01"] = { id = "test01" } }, ["character"] = { ["test01"] = { id = "test01" } }, ["gameseries"] = { ["test01"] = { id = "test01" } }, ["type"] = { ["test01"] = { id = "test01" } } } }'
