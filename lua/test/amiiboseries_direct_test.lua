...
describe("AmiiboseriesDirect", function()
  it("should direct-list-amiiboseries", function()
    local setup = amiiboseries_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-amiiboseries", setup.live and "live" or "unit")
...
function amiiboseries_direct_setup(mockres)
