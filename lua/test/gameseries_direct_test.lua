...
describe("GameseriesDirect", function()
  it("should direct-list-gameseries", function()
    local setup = gameseries_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-gameseries", setup.live and "live" or "unit")
...
function gameseries_direct_setup(mockres)
