...
describe("AmiiboDirect", function()
  it("should direct-list-amiibo", function()
    local setup = amiibo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-amiibo", setup.live and "live" or "unit")
...
function amiibo_direct_setup(mockres)
