...
|---|---|---|
| `ts/` | @voxgig-sdk/amiiboapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/amiiboapi-sdk \
      --repository voxgig-sdk/amiiboapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/amiiboapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/amiiboapi-sdk --id=<id>` removes it.
