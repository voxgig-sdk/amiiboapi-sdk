...
// Amiiboapi SDK clienttrack feature
...
class AmiiboapiClienttrackFeature extends AmiiboapiBaseFeature
{
    ...
    public function PostConstruct(AmiiboapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Amiiboapi-SDK';
