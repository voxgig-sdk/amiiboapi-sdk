...
// Amiiboapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AmiiboapiTestFeature extends AmiiboapiBaseFeature
{
    ...
    public function init(AmiiboapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AmiiboapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AmiiboapiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AmiiboapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AmiiboapiContext $ctx, $op, $args): array
    {
