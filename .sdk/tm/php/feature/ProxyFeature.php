...
class AmiiboapiProxyFeature extends AmiiboapiBaseFeature
{
    ...
    public function init(AmiiboapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AmiiboapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
