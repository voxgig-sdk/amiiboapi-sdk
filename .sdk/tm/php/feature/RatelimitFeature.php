...
// Amiiboapi SDK ratelimit feature
...
class AmiiboapiRatelimitFeature extends AmiiboapiBaseFeature
{
    ...
    private function _acquire(AmiiboapiContext $ctx): void
    {
    ...
    private function _track(AmiiboapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
