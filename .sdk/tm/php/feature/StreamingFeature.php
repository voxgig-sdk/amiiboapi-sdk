...
// Amiiboapi SDK streaming feature
...
class AmiiboapiStreamingFeature extends AmiiboapiBaseFeature
{
    ...
    private function _iterate(AmiiboapiResult $result): \Generator
    {
    ...
    private function _streamable(AmiiboapiContext $ctx): bool
    {
