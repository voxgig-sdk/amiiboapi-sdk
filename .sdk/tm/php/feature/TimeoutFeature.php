...
class AmiiboapiTimeoutFeature extends AmiiboapiBaseFeature
{
    ...
    private function _with_timeout(AmiiboapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AmiiboapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
