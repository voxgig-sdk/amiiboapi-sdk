...
// Amiiboapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AmiiboapiMakeRequest
{
    public static function call(AmiiboapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AmiiboapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AmiiboapiResponse($fetched);
        } else {
