...
// Amiiboapi SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AmiiboapiTransformResponse
{
    public static function call(AmiiboapiContext $ctx): mixed
    {
        ...
        $transform = AmiiboapiHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
