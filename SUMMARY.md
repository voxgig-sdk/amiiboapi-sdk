...
The selected API surface contains 5 entities and 5 HTTP routes. There are 6 SDK targets and 2 companion tools.
...
| --- | --- | --- | --- |
| Amiibo | `list` | `GET /amiibo` | See reference |
| Amiiboseries | `list` | `GET /amiiboseries` | See reference |
| Character | `list` | `GET /character` | See reference |
| Gameseries | `list` | `GET /gameseries` | See reference |
| Type | `list` | `GET /type` | See reference |

## Connect to the API

- Production server: `https://www.amiiboapi.com/api`
...
- `amiiboapi_list`: List records for an entity. Supported entities: `amiibo`, `amiiboseries`, `character`, `gameseries`, `type`.
- `amiiboapi_load`: Load one record for an entity. No active entity supports this operation.
