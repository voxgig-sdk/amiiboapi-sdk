...
func registerSDKWords(r *eng.Registry, client *sdk.AmiiboapiSDK) {
...
func runOp(client *sdk.AmiiboapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
