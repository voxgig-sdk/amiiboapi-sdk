// Command Amiiboapi-cli is a CLI + REPL for the Amiiboapi SDK,
...
const prompt = "amiiboapi"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "amiibo amiiboseries character gameseries type"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      AMIIBOAPI_APIKEY (api key), AMIIBOAPI_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: AMIIBOAPI_APIKEY carries the API key and
	// AMIIBOAPI_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("AMIIBOAPI_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("AMIIBOAPI_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewAmiiboapiSDK(opts)
