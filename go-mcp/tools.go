...
type Args struct {
	Entity string         `json:"entity" jsonschema:"amiibo | amiiboseries | character | gameseries | type"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AmiiboapiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "amiiboapi_list",
		Description: "List records from Amiiboapi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "amiiboapi_load",
		Description: "Load a single record from Amiiboapi. " +
...
func runOp(client *sdk.AmiiboapiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AmiiboapiSDK, name string) (sdk.AmiiboapiEntity, error) {
	switch strings.ToLower(name) {
	case "amiibo":
		return client.Amiibo(nil), nil
	case "amiiboseries":
		return client.Amiiboseries(nil), nil
	case "character":
		return client.Character(nil), nil
	case "gameseries":
		return client.Gameseries(nil), nil
	case "type":
