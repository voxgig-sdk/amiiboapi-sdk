...
class AmiiboseriesEntity
  ...
  def make
    opts = @_entopts.dup
    AmiiboseriesEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [AmiiboseriesListMatch, Hash, nil] match filter (any subset of
  #   Amiiboseries fields); defaults to nil, treated as an empty match that lists all.
