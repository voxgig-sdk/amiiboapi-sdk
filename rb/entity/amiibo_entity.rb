...
class AmiiboEntity
  ...
  # @return [Amiibo, Hash] the current Amiibo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Amiibo fields)
  def match_get
  ...
  #
  # @param reqmatch [AmiiboListMatch, Hash, nil] match filter (any subset of
  #   Amiibo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Amiibo>, Array] the matching Amiibo items; raises AmiiboapiError on failure
