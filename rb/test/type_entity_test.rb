...
class TypeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AMIIBOAPI_TEST_TYPE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def type_basic_setup(extra)
  ...
  entid_env_raw = ENV["AMIIBOAPI_TEST_TYPE_ENTID"]
