...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AmiiboapiOmni.make_runner(TEST_JSON_FILE, AmiiboapiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AmiiboapiOmni.errify(err)
    end
