...
class CharacterEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AMIIBOAPI_TEST_CHARACTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def character_basic_setup(extra)
  ...
  entid_env_raw = ENV["AMIIBOAPI_TEST_CHARACTER_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["AMIIBOAPI_TEST_CHARACTER_ENTID"])
