...
module AmiiboapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("AMIIBOAPI_TEST_LIVE")
    override = getenv("AMIIBOAPI_TEST_OVERRIDE")
    ...
    explain = getenv("AMIIBOAPI_TEST_EXPLAIN")
    m["AMIIBOAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AmiiboapiTestRunner
Helpers = AmiiboapiHelpers
Vs = VoxgigStruct
