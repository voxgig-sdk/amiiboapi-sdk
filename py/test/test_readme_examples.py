# Amiiboapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AmiiboapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AmiiboapiSDK(...) and AmiiboapiSDK.test(...) become
#      AmiiboapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "amiiboapi_sdk"
_SDK_CLASS = "AmiiboapiSDK"
