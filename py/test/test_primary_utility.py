...
_runner = makeRunner(TEST_JSON_FILE, AmiiboapiSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AmiiboapiSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AmiiboapiSDK.test(None, setup.get('a') or {})
