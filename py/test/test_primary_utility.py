...
from amiiboapi_sdk.core.spec import AmiiboapiSpec
from amiiboapi_sdk.core.result import AmiiboapiResult
from amiiboapi_sdk.core.response import AmiiboapiResponse
from amiiboapi_sdk.core.operation import AmiiboapiOperation
from amiiboapi_sdk.core.error import AmiiboapiError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return AmiiboapiError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AmiiboapiSDK.test(None, None)
        ...
        class TestInitFeature(AmiiboapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AmiiboapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AmiiboapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AmiiboapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AmiiboapiSDK.test(None, setup_opts)
