...
from amiiboapi_sdk.amiiboapi_types import (
    Amiiboseries,
...
class AmiiboseriesEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AmiiboseriesEntity(self._client, opts)
    ...
    def data_get(self) -> Amiiboseries:
    ...
    def match_get(self) -> Amiiboseries:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Amiiboseries]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Amiiboseries().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
