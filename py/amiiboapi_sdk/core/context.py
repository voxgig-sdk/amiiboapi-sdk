...
from amiiboapi_sdk.core.control import AmiiboapiControl
...
from amiiboapi_sdk.core.helpers import get_ctx_prop, to_map
...
class AmiiboapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AmiiboapiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AmiiboapiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AmiiboapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AmiiboapiError(code, msg, self)
