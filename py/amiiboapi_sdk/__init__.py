...
from amiiboapi_sdk.utility import register

# Load features
from amiiboapi_sdk.feature.base_feature import AmiiboapiBaseFeature
from amiiboapi_sdk.features import _has_feature, _make_feature
...
class AmiiboapiSDK:
    ...
    def get_utility(self):
        return AmiiboapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AmiiboapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Amiibo(self, data=None) -> "AmiiboEntity":
        ...
        from amiiboapi_sdk.entity.amiibo_entity import AmiiboEntity
    ...
    def Amiiboseries(self, data=None) -> "AmiiboseriesEntity":
        ...
        from amiiboapi_sdk.entity.amiiboseries_entity import AmiiboseriesEntity
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from amiiboapi_sdk.entity.character_entity import CharacterEntity
    ...
    def Gameseries(self, data=None) -> "GameseriesEntity":
        ...
        from amiiboapi_sdk.entity.gameseries_entity import GameseriesEntity
        return GameseriesEntity(self, data)


    def Type(self, data=None) -> "TypeEntity":
        """Entity factory: client.Type().list() / client.Type().load({"id": ...})."""
        from amiiboapi_sdk.entity.type_entity import TypeEntity
