...
The Golang SDK for the Amiiboapi API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/amiiboapi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/amiiboapi-sdk=../path/to/github.com/voxgig-sdk/amiiboapi-sdk
```
...
```
github.com/voxgig-sdk/amiiboapi-sdk/
...
The root package (`github.com/voxgig-sdk/amiiboapi-sdk`) re-exports everything needed
