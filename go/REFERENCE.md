# Amiiboapi Golang SDK Reference

Complete API reference for the Amiiboapi Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *AmiiboapiSDK`
...
#### `Amiibo(data map[string]any) AmiiboapiEntity`

Create a new `Amiibo` entity instance. Pass `nil` for no initial data.

#### `Amiiboseries(data map[string]any) AmiiboapiEntity`

Create a new `Amiiboseries` entity instance. Pass `nil` for no initial data.

#### `Character(data map[string]any) AmiiboapiEntity`

Create a new `Character` entity instance. Pass `nil` for no initial data.

#### `Gameseries(data map[string]any) AmiiboapiEntity`

Create a new `Gameseries` entity instance. Pass `nil` for no initial data.

#### `Type(data map[string]any) AmiiboapiEntity`
