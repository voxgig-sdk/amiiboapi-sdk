...
func NewGameseriesEntity(client *core.AmiiboapiSDK, entopts map[string]any) *GameseriesEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GameseriesEntity) GetName() string { return e.name }
...
func (e *GameseriesEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GameseriesEntity) Deleted() bool {
	return e.deleted
}


func (e *GameseriesEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGameseriesEntity(e.client, opts)
}

func (e *GameseriesEntity) Data(args ...any) any {
...
func (e *GameseriesEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gameseries; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GameseriesEntity) DataTyped(data ...Gameseries) Gameseries {
	if len(data) > 0 {
		return typedFrom[Gameseries](e.Data(asMap(data[0])))
	}
	return typedFrom[Gameseries](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gameseries (all fields
// optional at the wire level).
func (e *GameseriesEntity) MatchTyped(match ...Gameseries) Gameseries {
	if len(match) > 0 {
		return typedFrom[Gameseries](e.Match(asMap(match[0])))
	}
	return typedFrom[Gameseries](e.Match())
}
...
func (e *GameseriesEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GameseriesEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GameseriesEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GameseriesListMatch and returns []Gameseries. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GameseriesEntity) ListTyped(reqmatch GameseriesListMatch, ctrl map[string]any) ([]Gameseries, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Gameseries](res), nil
}



func (e *GameseriesEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GameseriesEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GameseriesEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GameseriesEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
