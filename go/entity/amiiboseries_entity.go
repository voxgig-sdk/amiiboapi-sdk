...
type AmiiboseriesEntity struct {
	name    string
...
func NewAmiiboseriesEntity(client *core.AmiiboapiSDK, entopts map[string]any) *AmiiboseriesEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AmiiboseriesEntity) GetName() string { return e.name }
...
func (e *AmiiboseriesEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AmiiboseriesEntity) Deleted() bool {
	return e.deleted
}


func (e *AmiiboseriesEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAmiiboseriesEntity(e.client, opts)
}

func (e *AmiiboseriesEntity) Data(args ...any) any {
...
func (e *AmiiboseriesEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Amiiboseries; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AmiiboseriesEntity) DataTyped(data ...Amiiboseries) Amiiboseries {
	if len(data) > 0 {
		return typedFrom[Amiiboseries](e.Data(asMap(data[0])))
	}
	return typedFrom[Amiiboseries](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Amiiboseries (all fields
// optional at the wire level).
func (e *AmiiboseriesEntity) MatchTyped(match ...Amiiboseries) Amiiboseries {
	if len(match) > 0 {
		return typedFrom[Amiiboseries](e.Match(asMap(match[0])))
	}
	return typedFrom[Amiiboseries](e.Match())
}
...
func (e *AmiiboseriesEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AmiiboseriesEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AmiiboseriesEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AmiiboseriesListMatch and returns []Amiiboseries. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AmiiboseriesEntity) ListTyped(reqmatch AmiiboseriesListMatch, ctrl map[string]any) ([]Amiiboseries, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Amiiboseries](res), nil
}



func (e *AmiiboseriesEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AmiiboseriesEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AmiiboseriesEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AmiiboseriesEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
