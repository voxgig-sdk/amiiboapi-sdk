...
const testSeed = `map[string]any{"entity": map[string]any{"amiibo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "amiiboseries": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "gameseries": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
