...
func (sdk *AmiiboapiSDK) OptionsMap() map[string]any {
...
func (sdk *AmiiboapiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AmiiboapiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AmiiboapiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AmiiboapiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AmiiboapiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AmiiboapiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AmiiboapiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AmiiboapiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AmiiboapiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AmiiboapiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
