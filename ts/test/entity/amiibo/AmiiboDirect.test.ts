...
describe('AmiiboDirect', async () => {
  ...
  test('direct-list-amiibo', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-amiibo', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AMIIBOAPI_TEST_AMIIBO_ENTID']
