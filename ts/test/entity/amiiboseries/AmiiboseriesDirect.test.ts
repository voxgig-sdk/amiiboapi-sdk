...
describe('AmiiboseriesDirect', async () => {
  ...
  test('direct-list-amiiboseries', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-amiiboseries', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AMIIBOAPI_TEST_AMIIBOSERIES_ENTID']
