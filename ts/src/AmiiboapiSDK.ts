...
class AmiiboapiSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('AmiiboapiSDK: graphql: ' +
  ...
  Amiibo(entopts?: Record<string, any>) {
    const self = this
    return new AmiiboEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Amiiboseries(entopts?: Record<string, any>) {
    const self = this
    return new AmiiboseriesEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Gameseries(entopts?: Record<string, any>) {
    const self = this
    return new GameseriesEntity(self, entopts)
  }
