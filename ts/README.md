# Amiiboapi TypeScript SDK



The TypeScript SDK for the Amiiboapi API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Amiibo()` — each with a small set of operations (`list`)
...
`list()` resolves to an array of Amiibo objects — iterate it directly:
...
const amiibo = await client.Amiibo().list()
// amiibo is a bare entity populated with mock response data
console.log(amiibo)
```
...
| `tester(testopts?, sdkopts?)` | `AmiiboapiSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `AmiiboapiSDK.test(testopts?, sdkopts?)` | `AmiiboapiSDK` | Create a test-mode client. |
...
| `client` | `client(): AmiiboapiSDK` | Return the parent SDK client. |
...
amiiboapi/
├── src/
│   ├── AmiiboapiSDK.ts        # Main SDK class
