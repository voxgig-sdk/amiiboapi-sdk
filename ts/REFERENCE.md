# Amiiboapi TypeScript SDK Reference

Complete API reference for the Amiiboapi TypeScript SDK.
...
```ts
new AmiiboapiSDK(options?: object)
```
...
#### `AmiiboapiSDK.test(testopts?, sdkopts?)`
...
**Returns:** `AmiiboapiSDK` instance in test mode.
...
Create a new `Amiibo` entity instance.
...
**Returns:** `AmiiboEntity` instance.

#### `Amiiboseries(data?: object)`

Create a new `Amiiboseries` entity instance.
...
**Returns:** `AmiiboseriesEntity` instance.
...
#### `Gameseries(data?: object)`

Create a new `Gameseries` entity instance.
...
**Returns:** `GameseriesEntity` instance.
...
Return the parent `AmiiboapiSDK` instance.
