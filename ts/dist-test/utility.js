...
function envOverride(m) {
    if ('TRUE' === process.env.AMIIBOAPI_TEST_LIVE ||
        'TRUE' === process.env.AMIIBOAPI_TEST_OVERRIDE) {
    ...
    m.AMIIBOAPI_TEST_EXPLAIN = process.env.AMIIBOAPI_TEST_EXPLAIN || m.AMIIBOAPI_TEST_EXPLAIN;
    return m;
}
