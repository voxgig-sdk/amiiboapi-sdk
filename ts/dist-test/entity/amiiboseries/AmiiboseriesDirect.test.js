...
(0, node_test_1.describe)('AmiiboseriesDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AmiiboapiSDK({
    ...
    (0, node_test_1.test)('direct-list-amiiboseries', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-amiiboseries', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AmiiboapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AMIIBOAPI_TEST_AMIIBOSERIES_ENTID'];
    ...
    const client = new __1.AmiiboapiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AmiiboseriesDirect.test.js.map