...
(0, node_test_1.describe)('AmiiboDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-amiibo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-amiibo', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AMIIBOAPI_TEST_AMIIBO_ENTID'];
...
//# sourceMappingURL=AmiiboDirect.test.js.map