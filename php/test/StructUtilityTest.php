...
// Amiiboapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AmiiboapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AmiiboapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(AmiiboapiOmni::structfix($val, Struct::undef()))) {
