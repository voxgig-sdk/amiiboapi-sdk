...
{
    private static function utility(): AmiiboapiUtility
    {
        return new AmiiboapiUtility();
    }
    ...
    private static function ctx(array $over = []): AmiiboapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AmiiboapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AmiiboapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AmiiboapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AmiiboapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AmiiboapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AmiiboapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AmiiboapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AmiiboapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AmiiboapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AmiiboapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AmiiboapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AmiiboapiResponse([]),
            'result' => new AmiiboapiResult([]),
        ]);
        [, $err] = AmiiboapiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec([]),
            'response' => null,
            'result' => new AmiiboapiResult([]),
        ]);
        [, $err] = AmiiboapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec(['step' => 's']),
            'response' => new AmiiboapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AmiiboapiResult([]),
        ]);
        [, $err] = AmiiboapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec(['step' => 's']),
            'response' => new AmiiboapiResponse(self::resp(200, ['v' => 1])),
            'result' => new AmiiboapiResult([]),
        ]);
        [, $err] = AmiiboapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec(['step' => 's']),
            'response' => new AmiiboapiResponse(self::resp(200, ['v' => 2])),
            'result' => new AmiiboapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AmiiboapiMakeResponse::call($ctx);
    ...
    {
        $preset = new AmiiboapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec([]),
            'response' => new AmiiboapiResponse([]),
            'result' => new AmiiboapiResult([]),
        ...
        [$got, $err] = AmiiboapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AmiiboapiResult([])]);
        [, $err] = AmiiboapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AmiiboapiSpec([]), 'result' => null]);
        [, $err] = AmiiboapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AmiiboapiSpec(['step' => 's']),
            'result' => new AmiiboapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AmiiboapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AmiiboapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AmiiboapiSpec(['step' => 's']),
            'result' => new AmiiboapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AmiiboapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AmiiboapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AmiiboapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AmiiboapiSpec([]),
            'result' => new AmiiboapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AmiiboapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AmiiboapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AmiiboapiError('boom', 'boom');
        $utility->fetcher = function (AmiiboapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AmiiboapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AmiiboapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AmiiboapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AmiiboapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AmiiboapiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AmiiboapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AmiiboapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AmiiboapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AmiiboapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AmiiboapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AmiiboapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AmiiboapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AmiiboapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AmiiboapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AmiiboapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AmiiboapiResult(['ok' => false])]);
        $this->expectException(AmiiboapiError::class);
        AmiiboapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AmiiboapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AmiiboapiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AmiiboapiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AmiiboapiBaseFeature();
        $b = new AmiiboapiBaseFeature();
        AmiiboapiFeatureAdd::call($ctx, $a);
        AmiiboapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AmiiboapiBaseFeature
    {
        $f = new AmiiboapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AmiiboapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AmiiboapiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AmiiboapiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AmiiboapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AmiiboapiResponse(['headers' => null]),
            'result' => new AmiiboapiResult([]),
        ]);
        AmiiboapiResultHeaders::call($ctx);
