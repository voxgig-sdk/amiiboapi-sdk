...
class GameseriesDirectTest extends TestCase
{
    public function test_direct_list_gameseries(): void
    {
        $setup = gameseries_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-gameseries", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
