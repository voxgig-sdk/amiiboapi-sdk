...
class AmiiboapiTestRunner
{
    ...
    {
        $live = self::getenv('AMIIBOAPI_TEST_LIVE');
        $override = self::getenv('AMIIBOAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AMIIBOAPI_TEST_EXPLAIN');
...
class_alias('AmiiboapiTestRunner', 'Runner');
class_alias('AmiiboapiHelpers', 'Helpers');
