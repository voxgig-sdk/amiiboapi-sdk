...
// Amiiboapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AmiiboapiSDK::test)
...
{
    private const SDK_CLASS = 'AmiiboapiSDK';
    ...
    private const SDK_BASE = 'amiiboapi_sdk';
