...
class AmiiboDirectTest extends TestCase
{
    public function test_direct_list_amiibo(): void
    {
        $setup = amiibo_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-amiibo", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
