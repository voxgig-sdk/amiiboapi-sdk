...
print_r(array_map(fn($item) => $item->data_get(), $character));
```
...
```
php/
├── amiiboapi_sdk.php          -- Main SDK class
...
The main class (`amiiboapi_sdk.php`) exports the SDK class
