...
class AmiiboapiGraphql
{
    ...
    // equivalent.
    public static function body(AmiiboapiContext $ctx): mixed
    {
    ...
    public static function errors(AmiiboapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
