...
// Amiiboapi SDK utility: fetcher

class AmiiboapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AmiiboapiSDK/1.0)';
    ...
    public static function call(AmiiboapiContext $ctx, string $fullurl, array $fetchdef): array
    {
