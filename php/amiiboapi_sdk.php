...
class AmiiboapiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AmiiboapiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AmiiboapiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AmiiboapiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AmiiboapiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AmiiboapiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AmiiboapiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AmiiboapiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AmiiboapiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AmiiboapiError($op . "_allow",
                "AmiiboapiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AmiiboapiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AmiiboapiError("graphql_error",
                "AmiiboapiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Amiibo($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_amiibo === null) {
                $this->_amiibo = new AmiiboEntity($this, null);
            }
            return $this->_amiibo;
        }
        return new AmiiboEntity($this, $data);
    }
    ...
    public function Amiiboseries($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_amiiboseries === null) {
                $this->_amiiboseries = new AmiiboseriesEntity($this, null);
            }
            return $this->_amiiboseries;
        }
        return new AmiiboseriesEntity($this, $data);
    }
    ...
    public function Gameseries($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_gameseries === null) {
                $this->_gameseries = new GameseriesEntity($this, null);
            }
            return $this->_gameseries;
        }
        return new GameseriesEntity($this, $data);
    }
