...
class AmiiboapiRbacFeature extends AmiiboapiBaseFeature
{
    ...
    private function _required(AmiiboapiContext $ctx): ?string
    {
    ...
    private function _reject(AmiiboapiContext $ctx, string $required): void
    {
    ...
    private function _track(AmiiboapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
