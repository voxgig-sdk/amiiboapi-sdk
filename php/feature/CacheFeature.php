...
class AmiiboapiCacheFeature extends AmiiboapiBaseFeature
{
    ...
    private function _through(AmiiboapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
