...
class AmiiboapiNetsimFeature extends AmiiboapiBaseFeature
{
    ...
    private function _simulate(AmiiboapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AmiiboapiContext $ctx, array $applied): void
    {
        $client = $this->client;
