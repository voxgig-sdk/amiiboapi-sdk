...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/amiiboapi` | `npm install @voxgig-sdk/amiiboapi` |
| Python | `voxgig-sdk-amiiboapi` | `pip install voxgig-sdk-amiiboapi` |
| PHP | `voxgig-sdk/amiiboapi` | `composer require voxgig-sdk/amiiboapi` |
| Golang | `github.com/voxgig-sdk/amiiboapi-sdk/go` | `go get github.com/voxgig-sdk/amiiboapi-sdk/go` |
| Ruby | `voxgig-sdk-amiiboapi` | `gem install voxgig-sdk-amiiboapi` |
| Lua | `voxgig-sdk-amiiboapi` | `luarocks install voxgig-sdk-amiiboapi` |
